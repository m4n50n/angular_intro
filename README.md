...
|`ng serve`|Construir e iniciar el proyecto. Con `-o` ordenamos que se abra el navegador al termina `--port` especificamos un puerto.<br>https://angular.io/cli/serve|
